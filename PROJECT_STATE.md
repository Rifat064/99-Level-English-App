...
| 2026-09-23 | 6.4 | Implemented SettingsScreen with Theme, TTS Accent, Notification Time, Words Per Day, and Auth actions. Applied theme dynamically in MainActivity. Updated TTS engine in DailyCardScreen. | assembleDebug passed. |
...
| 2026-09-23 | Exp | Transformed `LoginScreen.kt` to a modern landing page, redesigned `HomeScreen.kt` into a structured 2x2 dashboard inspired by Speak150, updated global light theme tokens to Navy Blue & Orange. Fixed Firebase `google-services.json` web client mismatch. | assembleDebug passed and installed on device successfully. |
| 2026-09-23 | Exp | Implemented Walkthrough carousel, Guest Name 3-day lockout in Splash, search bar in History, and a themed Settings overlay. Fixed smart cast errors and missing imports. | assembleDebug passed (BUILD SUCCESSFUL). |
